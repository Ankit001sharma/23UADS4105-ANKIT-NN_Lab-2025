...
class Perceptron:
    def init(self, input_size, learning_rate=0.1, epochs=1000):
...
# Step 3: Define Truth Tables for NAND and XOR
# NAND Truth Table
...
# Step 4: Initialize Perceptron and Train it
